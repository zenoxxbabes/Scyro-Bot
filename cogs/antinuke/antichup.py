...
class AntiChannelUpdate(commands.Cog):
    ...
    async def cog_load(self):
        print("✅ [AntiChannelUpdate] Extension loaded & DB initialized (MongoDB).")
    ...
    async def on_guild_channel_update(self, before, after):
        ...
        # Check Module Status
        module_doc = await self.modules_col.find_one({"guild_id": guild.id, "module": "channel_update"})
        ...
        if whitelist_doc and whitelist_doc.get("chup"):
            return
