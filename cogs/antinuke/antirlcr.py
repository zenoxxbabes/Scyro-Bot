...
class AntiRoleCreate(commands.Cog):
    ...
    async def cog_load(self):
        print("✅ [AntiRoleCreate] Extension loaded & DB initialized (MongoDB).")
    ...
    async def on_guild_role_create(self, role):
        ...
        # Check Module Status
        module_doc = await self.modules_col.find_one({"guild_id": guild.id, "module": "role_create"})
        ...
        if whitelist_doc and whitelist_doc.get("rlcr"):
            return
